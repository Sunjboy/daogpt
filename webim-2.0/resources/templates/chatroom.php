...
<script src="/resources/static/js/jquery.json.js"></script>
<script src="/resources/static/js/console.js"></script>
<script src="/resources/static/js/comet.js" charset="utf-8"></script>
<script src="/resources/static/js/chat.js" charset="utf-8"></script>
					...
					<div id="chat-tool"
						...
						<div style="float: left; width: 140px;">
							...
							<a onclick="toggleFace()" id="chat_face" class="chat_face"> <img
								src="/resources/static/img/face/15.gif" />
							</a>
						</div>
						...
						<form id="msgform" class="form-horizontal post-form">
							<div class="input-append">
								...
								<img style="width: 80px; height: 90px;"
									...
									src="/resources/static/img/button.gif" />
							</div>
						</form>
					</div>
				</div>
