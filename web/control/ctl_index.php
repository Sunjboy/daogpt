...
class ctl_index
{
	...
	public function get_url(){
		$headers = get_headers('http://www.wasu.cn/Play/show/id/4860197?refer=114la.com');
		var_dump($headers);
	}
    ...
    */
	...
	print ($content);
        if(empty($content))
        {
			...
			$seo['title'] = '算命最准的免费网站_免费算命_生辰八字算命_八字算命_周易算命_算卦_在线算命丨卦大师算命网';
			$seo['keywords'] = '免费算命,算卦,算命网,算命街,周易算命,八字算命,最准的免费网站';
			$seo['description'] = '算命最准的免费网站-卦大师算命网提供:2017鸡年,免费算命,姓名测试,周易,生辰八字算命,四柱算命预测,算卦,黄道吉日查询,抽签算命,生肖算命,在线排盘和趣味测试等在线免费算命内容！';
			tpl::assign('seo',$seo);
			$tpl     = 'index/index.tpl';
