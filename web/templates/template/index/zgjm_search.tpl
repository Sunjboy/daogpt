...
<{include file='./index/public/path.tpl'}>  
	...
	<div class="mod_box_t1 fn_box fn_zgjm_search">
        ...
        <div class="dream_search">
            ...
            <img src="<{$web_url}>static/bazi/images/suanming/v2/title-pic.jpg" alt="周公解梦大全" class="title-pic">
						...
						<div class="intro_tab_cont" id="contents_search">
                            ...
                            <ul class="clearfix mt10 nobt">
                                ...
                                <{foreach from=$data item=v key=k}>
                                    <li><a href="<{$web_url}>zgjm/show-<{$v.id}>.html" target="_blank"><{$v.title}></a></li>
                                <{/foreach}>
