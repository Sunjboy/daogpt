...
<div class="mod_2b">
					<h2><img src="/static/bazi/img/life/icon_date.png">《神算网》历史上的今天 — <span class="cYellow" id="date_select"><{if $dateday}><{$dateday}><{else}><?php echo date('m月-d日',time());?><{/if}></span></h2>
