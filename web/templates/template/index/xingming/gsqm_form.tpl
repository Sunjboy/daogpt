...
<div class="cont">
<div class="col_left">
<div class="fn_part fn_gsqm mod_box_t1">
              <div class="hd">
                <h1>公司名称评分</h1>
              </div>
              <div class="bd">
                  <div class="box_con">
                    <div class="intro_area"><strong>「<a href="<{$web_url}>xingming/xmfx/">神算网名称测试</a>」</strong>为您的企业、公司名称评分。名字是一个符号不假，但它却是一个非常特别、极其重要的符号。详细名字评分分析还须要配合个人八字五行匹配，名字评分信则灵不信则不灵。请在下面输入你要测试的名称进行<a href="<{$web_url}>xingming/xmfx/">评分测试</a>吧！
</div>
                    ...
                    <div class="line"></div>
                    <h3 class="btitle">为你推荐</h3>
                    
                    <div class="fn_gsqm_result">
                      <ul id="complay_list" class="gsqm_list clearfix">
