...
<div class="col_left">
			  <div class="mod_box_t1 fn_part fn_gy">
					<div class="hd">
						<h1><img src="<{$web_url}>static/bazi/images/suanming/tit/chouqian.png">王公灵签</h1>
					</div>
					<div class="bd">
                    ...
                    <{if $qid!=''}>
                        ...
                        <div style="display:block; float:left; margin-top:30px;">
                        	<a href="<{$web_url}>chouqian/wanggong/" class="btn_orange_1">重新抽签</a>
                        </div>
					<{/if}>
              ...
              <{if $rand!=''}>
                  ...
                  <{if $gysmile!='4' && $clicknum<3}>
                        ...
                        <{else}>
                        <h5><a href="<{$web_url}>chouqian/wanggong/<{$clicknum+2}>/<{$rand}>"></a><img src="<{$web_url}>static/bazi/img/suanming/good_cup.gif" /></h5>
                        <{/if}>
                        <p class="last"><span class="cRed">您掷出<{$clicknum+1}>次圣杯，请点击上图再次掷出！</span></p>
                        
                        <{if $clicknum==2}>
                        	<p class="last"><span class="cRed">恭喜，您连续掷出了三次圣杯，<a href="<{$web_url}>chouqian/wanggong/4/<{$rand}>">请点这里察看签词！</a></span></p>
                        <{else}>
                  ...
                  <{else}>
                        ...
                        <p class="last"><span class="cRed">您掷出笑杯了，此签不准。<a href="<{$web_url}>chouqian/wanggong/">请点这里重新抽签！</a></span></p>
              ...
              <{if $qid=='' && $rand==''}>
                    <h6><a href="<{$web_url}>chouqian/wanggong/1" title="首先请您心无杂念，然后点这里开始抽签"><img src="<{$web_url}>static/bazi/img/suanming/v2/qian.gif" alt="灵签"></a></h6>
