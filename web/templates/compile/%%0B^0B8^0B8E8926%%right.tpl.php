<?php /* Smarty version 2.6.25, created on 2018-03-25 16:47:51
...
<div class="mod_box_t2 hot_tool_part nobor_bom">
    ...
    <div class="bd bd_s1">
        <ul class="mod_txt">
        <?php $_from = $this->_tpl_vars['public_hand_data']['public_right_smdq']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
hdjr/zeri/">查吉日</a><a target="_blank" href="<?php echo $this->_tpl_vars['web_url']; ?>
hdjr/lishi/">历史今天</a></div>
    	</div>
</div>
<!------>
...
2016/1.html" class="sx-1">鼠</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/2.html" class="sx-2">牛</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/3.html" class="sx-3">虎</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/4.html" class="sx-4">兔</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/5.html" class="sx-5">龙</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/6.html" class="sx-6">蛇</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/7.html" class="sx-7">马</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/8.html" class="sx-8">羊</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/9.html" class="sx-9">猴</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/10.html" class="sx-10">鸡</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/11.html" class="sx-11">狗</a>
        <a href="<?php echo $this->_tpl_vars['web_url']; ?>
2016/12.html" class="sx-12">猪</a>
    </div>
</div>
<!--
