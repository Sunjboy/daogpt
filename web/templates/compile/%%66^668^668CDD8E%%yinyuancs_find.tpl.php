<?php /* Smarty version 2.6.25, created on 2017-12-17 19:22:04
...
时
	...
	<div class="sl_box">
		...
		<div class="J_listCon result_list_content">
			...
			<div class="public_con_word">
				<p>
					<?php echo $this->_tpl_vars['data']['data']['username']; ?>
的八字中日支为子午卯酉中的一者，表示另一半相貌较好。另外八字中伤官透干、表示你生命中的TA在身高方面有一定的优势。伤官透干，婚姻若想美满，最好配偶距离较远为宜。
				</p>
			</div>
			<p class="public_title">
				对方性格
			...
			<div class="public_con_word">
				<p>
					从<?php echo $this->_tpl_vars['data']['data']['username']; ?>
的八字中得知正官为喜用，表示生命中的TA聪明有见识，行事知分寸而带有贵气，细心致密，朴素勤俭。另外一个特点是八字中食伤生财，对方头脑聪明灵活，精巧能干，会做生意。但因欲望强，不易满足，故而每天忙碌，追求实利。个性开朗，富正义感，豪爽好施，故人缘佳，异性缘亦佳。
				</p>
			</div>
			<p class="public_title">
				婚姻方面
			...
			<div class="public_con_word">
				<p>
					<p>注：婚姻感情方面不顺，易因此陡增烦恼。其不顺内容包括：晚婚、多恋不成、婚后不睦、分居、外遇、离婚、婚后一方多病等，应此则不应彼。</p>
...
　　<p>最重要的是要能忍让。</p>
	...
	<div class="sl_box">
		...
		<div class="J_listCon result_list_content">
			...
			<div class="public_con_word">
				<p>
					命中官星比较旺，异性缘比较好，能多得异性帮助。但<?php echo $this->_tpl_vars['data']['data']['username']; ?>
的八字中官星离日干比较远，与配偶婚后感情会日益淡化、在八字中官星不宜太旺，也不宜官杀混杂，大都有感情困扰，要么是自命不凡，孤芳自赏，气傲性慢，刚柔失常，自寻烦恼！
				</p>
			</div>
			<p class="public_title">
				婚姻建议
			...
			<div class="public_con_word">
				<p>
					从<?php echo $this->_tpl_vars['data']['data']['username']; ?>
的八字中总体分析结合最近几年的流年运判断，感情运势方面比较一般，但从八字中正官为喜用结合2018戊戌年运，感情方面已经处于上升趋势、所以暂时感情运淡还请不要着急、另外你可以在卧室种植一些盆栽最好能开花的，卧室影响一个人的运势因素最大，所以提升卧室生机有利提升总体运势，鲜花象征的爱情、所以种植能开花的盆栽有助提升自身感情运，从而提高感情质量。
				</p>
			</div>
		</div>
	</div>
...
<?php else: ?>1<?php endif; ?>朵
	...
	<div class="sl_box">
		...
		<div class="J_listCon result_list_content">
			...
			<div class="public_con_word">
				<p>
					八字中<?php if ($this->_tpl_vars['data']['data']['username'] == 1): ?>男<?php else: ?>女<?php endif; ?>命伤官透干生财，不宜早婚、最佳结婚年龄22岁、23岁、25岁、27岁。另外结婚<?php echo $this->_tpl_vars['data']['data']['username']; ?>
的八字总体而言感情运势一般，如若早婚会出现早婚必离的情况，所以在结婚之前多谈几次恋爱，可以有效的排泄婚后的感情不良因素，从而提高婚后感情质量。
				</p>
			</div>
		</div>
	</div>
...
的是否稳定？
			...
			<div class="public_con_word">
				<p>
				正才为忌神，但夫妻宫为喜用神，表明对方自身条件好、品质好，但却不能帮助自己。另外从你的八字性格上看，婚姻生活会多多少少的受到你的性格影响导致感情淡化。对于<?php if ($this->_tpl_vars['data']['data']['username'] == 1): ?>男<?php else: ?>女<?php endif; ?>性而言、婚后控制好自己的性格能够提升感情运势哦！古人云：修身养性才是渡世金方！感情方面也是如此！
				</p>
			</div>
		</div>
	</div>
	...
	<div class="sl_box">
		...
		<div class="J_listCon result_list_content">
			...
			<div class="public_con_word">
				<p>
				<?php echo $this->_tpl_vars['data']['data']['username']; ?>
的八字上分析有偏财的存在、俗话说：人不得偏财不富、马不吃野草不肥，八字中有偏财、事业财运方面会给对方很大的帮助。虽然你不能得到对方的帮助，但你却有帮助对方的命运，所以在事业财运方面自己要多拿主意多提意见、或许会因为你的一些指点意见让对方在事业财运方面有所收获。八字中有偏财、并不是说一定能帮助对方、但人逢偏财运事业财运比较好罢了！另外你自己也适合做生意干事业。
				</p>
			</div>
		</div>
	</div>
