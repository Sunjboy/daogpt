<?php /* Smarty version 2.6.25, created on 2017-12-03 18:34:48
         compiled from h5/suanming/fengshui_form.tpl */ ?>
...
<div class="detail">
    <dl>
        ...
        <form id="sm" action="/index.php"  method="post" onSubmit="return checkbz();">
            ...
            <dd class="form"><strong>性别</strong>：<input type="radio" name="xb" id="mingtype1" value="1" checked>
