<?php /* Smarty version 2.6.25, created on 2017-12-04 04:09:21
         compiled from h5/chouqian/guanyin.tpl */ ?>
...
<?php if ($this->_tpl_vars['qid']): ?>
    <h1 class="title"><?php echo $this->_tpl_vars['qian']['qianming']; ?>
</h1>
<?php else: ?>
...
static/bazi/img/suanming/good_cup.gif" />
                    <?php else: ?>
                        <a href="/chouqian/guanyin/<?php echo $this->_tpl_vars['clicknum']+2; ?>
...
次圣杯，请点击上图再次掷出！</span></p>
                    ...
                    <?php if ($this->_tpl_vars['clicknum'] == 2): ?>
                        <p><span class="green">恭喜，您连续掷出了三次圣杯，<a href="/chouqian/guanyin/4/<?php echo $this->_tpl_vars['rand']; ?>
">请点这里察看签词！</a></span></p>
                        <p><a href="/chouqian/guanyin/4/<?php echo $this->_tpl_vars['rand']; ?>
"><img src="/static/img/chakan.gif" width="94" height="31" alt="查看签词" /></a></p>
                    <?php else: ?>
                        ...
                        <p><a href="/chouqian/guanyin/<?php echo $this->_tpl_vars['clicknum']+2; ?>
/<?php echo $this->_tpl_vars['rand']; ?>
...
static/bazi/img/suanming/bad_cup.gif" alt="重新抽签" /></a></p><br />
        ...
        <?php if ($this->_tpl_vars['qid'] == '' && $this->_tpl_vars['rand'] == ''): ?>
            <div class="h2_content"><p>专业版观音灵签有100签，观音灵签为您提供解签，三种签的签文自古至今流传久远，各地观音灵签抽签略有不同。也有少数佛寺院使用这种签种观音灵签解签，首先要有一棵真诚的心态，闭上眼睛请求指点的事情。如婚姻、事业、运程、流年、工作、财运......所谓的心诚则灵啊，之后才开始。</p></div>
            <center>
                    <a href="/chouqian/guanyin/1"><img id="lingqian" src="<?php echo $this->_tpl_vars['web_url']; ?>
