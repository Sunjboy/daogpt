<?php /* Smarty version 2.6.25, created on 2018-04-07 16:07:01
         compiled from ffsm/bazi3.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<img style="width:99%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/000.jpg" alt="八字精批"/>
	...
	<form class="J_ajaxForm J_testFixedTop" id="submit1" action="/?ac=bazi" name="login" method="post" onSubmit="return checkForm();">
		<div class="public_form_wrap" id="miaodian">
			<ul>
				...
				<div class="auto">
					<input type="text" id="birthday" data-input-id="b_input" class="Js_date" data-type="0" placeholder="请选择日期" data-date="1980-3-1">
				</div>
				</li>
                <li>
				<div class="left">
...
<a href="http://suanming.03ky.com/xiangxuezhenjing/" target="_blank"><img style="width:100%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/shu.jpg" alt="相学真经"/></a>
<hr />
...
<script type="text/javascript">
        function pushHistory() {
            var url = "https://www.03ky.com/2018/";
