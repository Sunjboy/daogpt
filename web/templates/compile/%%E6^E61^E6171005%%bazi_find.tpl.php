<?php /* Smarty version 2.6.25, created on 2017-12-18 21:52:41
         compiled from ffsm/bazi_find.tpl */ ?>
﻿<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8"/>
	<title>八字精批-开运网</title>
...
<?php else: ?>这种类型的<?php if ($this->_tpl_vars['data']['data']['username'] == 1): ?>男<?php else: ?>女<?php endif; ?>性有知性的魅力，稍带忧郁的气质很受异性的欢迎。凡是追求他的异性，一概来者不拒，一个星期可能和七个人约会。此外，因他具有果敢的行动力，所以也常会主动邀约他人。壬日<?php if ($this->_tpl_vars['data']['data']['username'] == 1): ?>男<?php else: ?>女<?php endif; ?>性很擅长“一夜风流”，从吃饭、饮酒到饭店这一个过程视以知性的背景，制造了绝妙的气氛，使他们无往不利。由于自由的恋爱观，使他们甚少有从一异性而终的心态。<?php endif; ?>
				</p>
			</div>
			<p class="public_title">
				命带多少桃花运
