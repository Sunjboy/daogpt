<?php /* Smarty version 2.6.25, created on 2017-11-29 10:54:12
         compiled from index/zgjm_search.tpl */ ?>
...
static/bazi/images/suanming/v2/title-pic.jpg" alt="周公解梦大全" class="title-pic">
        ...
        <div class="cont">
			...
			<div class="col_left">
				...
				<div class="mod_box_t1 nomt">
                	...
                	<div class="hd">
                		<h3 class="art_title">【 <?php echo $this->_tpl_vars['q']; ?>
 - 解梦 】</h3>
					</div>

					<div class="bd">
                    
						<div class="intro_tab_cont" id="contents_search">
...
zgjm/show-<?php echo $this->_tpl_vars['v']['id']; ?>
