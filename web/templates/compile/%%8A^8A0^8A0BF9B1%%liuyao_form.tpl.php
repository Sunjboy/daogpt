<?php /* Smarty version 2.6.25, created on 2017-12-01 00:22:01
         compiled from index/paipan/liuyao_form.tpl */ ?>
...
index.php" name="form1" method="post" onSubmit="return checkForm();">
...
<INPUT onClick="javacript:yg1.style.display='none';yg2.style.display='none';yg3.style.display='none';yg4.style.display='none';yg5.style.display='none';fangfa=1;" 
      type=radio  value="1" name=auto>
            电脑自动&nbsp;
                                    ...
                                    <IMG height="87" src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb.gif" width="83" border="0"  name="q1">　　
                                    <IMG height=87 src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb.gif" width="83" border="0" name="q2">　　
                                    <IMG height="87" src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb.gif" width="83" border="0" name="q3">
                                    </div>
...
{  if(form1.b1.value=='停 止')
   ...
   if(ok!=0)
	...
	{     
		times++;     
		document.q1.src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb2.gif"     
		document.q2.src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb2.gif"     
		document.q3.src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb2.gif"	     
	}	     
	else					    
	{     
		document.q1.src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb.gif"     
		document.q2.src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb.gif"     
		document.q3.src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/images/qltb.gif"     
