<?php /* Smarty version 2.6.25, created on 2017-12-03 12:41:52
         compiled from h5/chouqian/wanggong.tpl */ ?>
...
static/bazi/img/suanming/good_cup.gif" />
            <?php else: ?>
            <a href="/chouqian/wanggong/<?php echo $this->_tpl_vars['clicknum']+2; ?>
...
次圣杯，请点击上图再次掷出！</span></p>
            ...
            <?php if ($this->_tpl_vars['clicknum'] == 2): ?>
            <p><span class="green">恭喜，您连续掷出了三次圣杯，<a href="/chouqian/wanggong/4/<?php echo $this->_tpl_vars['rand']; ?>
">请点这里察看签词！</a></span></p>
            <p><a href="/chouqian/wanggong/4/<?php echo $this->_tpl_vars['rand']; ?>
"><img src="/static/img/chakan.gif" width="94" height="31" alt="查看签词" /></a></p>
            ...
            <p><a href="/chouqian/wanggong/<?php echo $this->_tpl_vars['clicknum']+2; ?>
/<?php echo $this->_tpl_vars['rand']; ?>
"> <img src="/static/img/qiuqian.gif" width="94" height="31" alt="开始抽签" /></a></p>
            ...
            <p><a href="/chouqian/wanggong/"><img src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/img/suanming/bad_cup.gif" alt="重新抽签" /></a></p><br />
        ...
        <br /><br />
            ...
            <center>
                <a href="/chouqian/wanggong/1"><img id="lingqian" src="<?php echo $this->_tpl_vars['web_url']; ?>
