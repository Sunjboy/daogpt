<?php /* Smarty version 2.6.25, created on 2017-12-01 23:55:53
         compiled from index/peidui/hehun_form.tpl */ ?>
						...
						<div class="mod_box_t3 fn_box">
							...
							<div class="box_con">
								...
								<div class="mod_form">
									...
									<form onSubmit="return chk_bzhh()" method="post" action="<?php echo $this->_tpl_vars['web_url']; ?>
index.php">
...
static/bazi/img/suanming/v2/boy_icon.png" alt="男人" class="item_imgIcon">男方姓名：</span>
									...
									<div class="form_item">
										...
										<span><img src="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/img/suanming/v2/girl_icon.png" alt="女人" class="item_imgIcon">女方姓名：</span>
