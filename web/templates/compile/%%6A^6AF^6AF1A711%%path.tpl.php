<?php /* Smarty version 2.6.25, created on 2017-11-29 20:02:23
         compiled from ./h5/public/path.tpl */ ?>
当前位置：<a href="/">神算网</a> &gt; 
<?php if ($this->_tpl_vars['path']['baba']['name'] != ''): ?><a href="/<?php echo $this->_tpl_vars['path']['baba']['extra']; ?>
" title="<?php echo $this->_tpl_vars['path']['baba']['name']; ?>
"><?php echo $this->_tpl_vars['path']['baba']['name']; ?>
</a> &gt; <?php endif; ?> 
<?php if ($this->_tpl_vars['path']['parent_arr']['name'] != ''): ?><a href="/<?php echo $this->_tpl_vars['path']['parent_arr']['extra']; ?>
" title="<?php echo $this->_tpl_vars['path']['parent_arr']['name']; ?>
"><?php echo $this->_tpl_vars['path']['parent_arr']['name']; ?>
</a> &gt; <?php endif; ?>
<?php if ($this->_tpl_vars['path']['name'] != ''): ?><a href="/<?php echo $this->_tpl_vars['path']['extra']; ?>
