<?php /* Smarty version 2.6.25, created on 2017-12-10 04:44:02
         compiled from index/suanming/fengshui_form.tpl */ ?>
                ...
                <div class="mod_box_t1 fn_part fn_fengshui">
                    ...
                    <div class="bd">
                       ...
                       <div class="mod_box_t3 fn_box">
                        ...
                        <div class="introWord">
                        <p>通过<a href="<?php echo $this->_tpl_vars['web_url']; ?>
">神算网</a>风水测算，输入年份，性别，朝向来测试你所在的环境在你的八字下是否是一块风水宝地</p>
						...
						<p>风水是人类在长期的居住实践中积累的宝贵经验。朝阳光、避风雨、防火灾，近水源、利出行成了最基本的居住理论。风水贯寄在中国传统建筑活动的各个过程。从选址规划、建筑单体、园林小品、室内外装修设计到施工营造，几乎无所不在。</p>
										<i class="flag_tl_t3"></i><i class="flag_tr_t3"></i><i class="flag_bl_t3"></i><i class="flag_br_t3"></i></div><!-- 热词 end--></div><i class="flag_tl_t1"></i><i class="flag_tr_t1"></i></div>
