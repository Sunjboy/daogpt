<?php /* Smarty version 2.6.25, created on 2017-12-08 16:11:17
...
<div class="jieming_box">
	...
	<div class="jb_bzmp">
		...
		<div class="jb_bzmp_bottom">
			...
			<ul class="zodiac_pic">
				<li style="float: left;text-align:center;"><a href="#"><img width="50" src="/statics/img/<?php echo $this->_tpl_vars['return']['data']['xiyongshen']['sanhe']['sanhetu']['0']; ?>
...
"/>
				...
				<li style="float: left;text-align:center;" class="zodiac_img_fs "><a href="#"><img width="50" src="/statics/img/<?php echo $this->_tpl_vars['return']['data']['xiyongshen']['sanhe']['sanhetu']['1']; ?>
...
"/>
				...
				<li style="float: left;text-align:center;" class="zodiac_img_fs "><a href="#"><img width="60" src="/statics/img/<?php echo $this->_tpl_vars['return']['data']['xiyongshen']['sanhe']['sanhetu']['2']; ?>
