<?php /* Smarty version 2.6.25, created on 2017-12-04 23:09:08
         compiled from index/xingzuo/yunshi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'base64_decode', 'index/xingzuo/yunshi.tpl', 69, false),array('modifier', 'truncate', 'index/xingzuo/yunshi.tpl', 81, false),)), $this); ?>
...
<h1 class="fc1">十二星座今日运势 <small class="fc2"><?php echo date('Y年-m月-d日',time()); ?></small></h1>
   ...
   <dd><ul><li><label>整体运势：</label><em><span class="star_b"><span class="star_f" style="width:<?php echo $this->_tpl_vars['xz_yunshi']['401']['content']['zonghe']; ?>
px;"></span></span></em></li><li><label>爱情运势：</label><em><span class="star_b"><span class="star_f" style="width:<?php echo $this->_tpl_vars['xz_yunshi']['401']['content']['aiqing']; ?>
