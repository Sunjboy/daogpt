<?php /* Smarty version 2.6.25, created on 2017-11-29 21:03:40
         compiled from index/huangli/zeri.tpl */ ?>
...
static/bazi/css/suanming/v2/huangli.css"/>
<link type="text/css" rel="stylesheet" href="<?php echo $this->_tpl_vars['web_url']; ?>
static/bazi/css/suanming/v2/base_hl.css"/>
<div class="wrapper">
    <div class="main">
        <div class="menu_xy">
...
<!-- 百度热词 end -->
                        ...
                        <?php if ($this->_tpl_vars['nums']): ?>
							<div id="result_header"><p class="total_p">宜<strong><?php echo $this->_tpl_vars['lmanacCond']; ?>
</strong>的日子一共有<span><?php echo $this->_tpl_vars['nums']; ?>
</span>天<a class="total_p_back" href="/hdjr/">返回今日黄历</a></p></div>
                            <?php endif; ?>
...
<table class="data_table mt10" id="table_<?php echo $this->_tpl_vars['k']; ?>
"><thead><tr><th colspan="5"><div class="thead_th <?php if ($this->_tpl_vars['k'] == 0): ?>thead_th_deep<?php else: ?>thead_th_light<?php endif; ?>"><div class="thead_th_rt"></div><div class="thead_th_lt"></div><strong><?php echo $this->_tpl_vars['v']['gongli']; ?>
  <?php echo $this->_tpl_vars['v']['nongli']; ?>
</strong><a class="slide_dn" id="slide_1" href="<?php echo $this->_tpl_vars['web_url']; ?>
hdjr/<?php echo $this->_tpl_vars['v']['date']; ?>
" target="_blank" onclick="showTable('table_1')"></a></div></th></tr></thead>

<?php if ($this->_tpl_vars['k'] == 0): ?>
<tbody>
<tr>
    <th class="bg_light" width="98"><em class="c_light">节日</em></th>
    <td class="bg_light" width="224"><?php echo $this->_tpl_vars['v']['jieri']; ?>
</td>
    <th width="110">彭祖百忌</th>
    <td width="224"><?php echo $this->_tpl_vars['v']['baiji']; ?>
</td>
...
<tr>
    ...
    <div class="luck_td">
        ...
        <?php if ($this->_tpl_vars['v']['yi'] != '-'): ?><?php echo $this->_tpl_vars['v']['yi']; ?>
...
<tr>
    ...
    <td colspan="4">
    <div class="bad_td">
        <?php if ($this->_tpl_vars['v']['ji'] != '-'): ?><?php echo $this->_tpl_vars['v']['ji']; ?>
<?php else: ?>诸事不宜<?php endif; ?>
    </div>
    </td>
</tr>
...
<tr>
    ...
    <td><div class="nowell_td"><em><?php echo $this->_tpl_vars['v']['chong']; ?>
</em></div></td>
    <th>凶神宜忌</th>
    <td colspan="2"><?php echo $this->_tpl_vars['v']['jishen']; ?>
</td>
</tr>
<tr>
    <th>吉神宜趋</th>
    <td colspan="4"><?php echo $this->_tpl_vars['v']['xiongshen']; ?>
</td>
</tr>
</tbody>
...
<tfoot>
    <tr>
        <td colspan="5">
        <dl>
            <dt>岁次</dt><dd><?php echo $this->_tpl_vars['v']['suici']; ?>
</dd>
            <dt>五行</dt><dd><?php echo $this->_tpl_vars['v']['wuxing']; ?>
</dd>
            <dt class="god_child"><i></i>胎神</dt>
            <dd class="last"><?php echo $this->_tpl_vars['v']['taishen']; ?>
</dd>
        </dl></td>
    </tr>
    <tr>
        <td colspan="5"><dl><dt class="god_money"><i></i>财神</dt><dd><?php echo $this->_tpl_vars['v']['caishen']; ?>
</dd><dt class="god_happy"><i></i>喜神</dt><dd><?php echo $this->_tpl_vars['v']['xishen']; ?>
</dd><dt class="god_luck"><i></i>福神</dt><dd class="last"><?php echo $this->_tpl_vars['v']['fushen']; ?>
</dd></dl></td>
    </tr>
</tfoot>
<?php endif; ?>
