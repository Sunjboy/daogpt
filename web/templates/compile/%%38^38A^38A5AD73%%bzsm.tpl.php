<?php /* Smarty version 2.6.25, created on 2018-01-11 14:10:59
         compiled from index/suanming/bzsm.tpl */ ?>
...
<span class="sDes"><em><?php echo $this->_tpl_vars['dayundate']; ?>
</em></span><br />

<p>

大运十神:<?php echo $this->_tpl_vars['dr_ss']; ?>
<br />

大运干支:<?php echo $this->_tpl_vars['dr_gz']; ?>
<br />

交运年份:<?php echo $this->_tpl_vars['dr_y']; ?>
...
交运年龄:><?php echo $this->_tpl_vars['nnnn']+1; ?>
...
<p>近12月运气:<?php echo $this->_tpl_vars['myq_text']; ?>
</p>

<p>对你的忠言:喜神是<font color=#0033FF><b><?=$wh[$whh]?></b></font> <font color="#FF0000"><b><?php echo $this->_tpl_vars['wh123']; ?>
</b></font>  趋吉避凶的忠言<br><br style=line-height=70%></p>
...
suanming/clear/" onClick="recesuan();return false;">重新测算</a>
