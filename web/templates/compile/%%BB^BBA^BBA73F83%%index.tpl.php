<?php /* Smarty version 2.6.25, created on 2017-12-07 16:48:27
         compiled from index/haoma/index.tpl */ ?>
						...
						<div class="mod_box">
							<div class="box_con clearfix">
								<div class="form_item mod_box_t3 form_sj">
									<h3>手机号码吉凶</h3>
									<form name="theform" onSubmit="return checkjx();" method="post" action="<?php echo $this->_tpl_vars['web_url']; ?>
index.php">
...
index.php" name="form1" method="post">
                                    <input type="hidden" name="ct" value="haoma" />
