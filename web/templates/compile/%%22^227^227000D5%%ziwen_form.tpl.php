<?php /* Smarty version 2.6.25, created on 2017-12-04 00:07:45
         compiled from h5/minjian/ziwen_form.tpl */ ?>
...
<div class="detail">
	...
	<?php else: ?>
		<div class="detail">
			<p class="first">性格解析：<strong class="red"><?php echo $this->_tpl_vars['data']['jiexi']; ?>
</strong></p>
		</div>
	<?php endif; ?>
