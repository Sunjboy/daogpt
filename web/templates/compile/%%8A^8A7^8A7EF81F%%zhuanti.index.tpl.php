<?php /* Smarty version 2.6.25, created on 2018-02-01 11:39:09
         compiled from admin/zhuanti.index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'admin/zhuanti.index.tpl', 278, false),)), $this); ?>
...
&amp;ac=edit&amp;zt_id=<?php echo $this->_tpl_vars['v'][$this->_tpl_vars['_dbfield']['mainKey']]; ?>
...
&amp;ac=delete&amp;zt_id=<?php echo $this->_tpl_vars['v'][$this->_tpl_vars['_dbfield']['mainKey']]; ?>
...
<?php else: ?>未知操作名称<?php endif; ?></button>&nbsp; &nbsp;
                                <?php elseif ($this->_tpl_vars['vext']['type'] == 'new'): ?>
                                    <?php if ($this->_tpl_vars['v']['zt_type'] == 2): ?>
                                        <a href='<?php echo $this->_tpl_vars['v'][$this->_tpl_vars['vext']['paramfrom']]; ?>
' target="_blank" class="btn" style="cursor:pointer;"><?php if ($this->_tpl_vars['vext']['title'] != ''): ?><?php echo $this->_tpl_vars['vext']['title']; ?>
