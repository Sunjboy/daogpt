<?php /* Smarty version 2.6.25, created on 2017-11-30 17:29:27
         compiled from h5/zgjm_show.tpl */ ?>
...
<h1 class="title">梦见<?php echo $this->_tpl_vars['data']['title']; ?>
怎么回事？</h1>
<div class="detail">
    <div class="remark center">时间：<?php echo $this->_tpl_vars['data']['uptime']; ?>
 &nbsp; 来源：神算网</div>

    <h2>1. 梦见<?php echo $this->_tpl_vars['data']['title']; ?>
的周公解梦：</h2>
